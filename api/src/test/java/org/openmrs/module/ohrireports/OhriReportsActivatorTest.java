 ...
 *
 */
public class OhriReportsActivatorTest {
    ...
    public void testSetupOpenmrsIdWhenNotSetUp() throws Exception {
        ...
        OhriReportsActivator activator = new OhriReportsActivator();
        ...
        verify(patientService).savePatientIdentifierType(argThat(new ArgumentMatcher<PatientIdentifierType>() {
            ...
            public boolean matches(Object argument) {
                ...
                return actual.getName().equals(OhriReportsConstants.OPENMRS_ID_NAME);
            }
        }));
